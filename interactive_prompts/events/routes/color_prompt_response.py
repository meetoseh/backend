...
async def respond_to_interactive_prompt_color_prompt(
    args: CreateInteractivePromptEventRequest[EventRequestDataT],
    authorization: Optional[str] = Header(None),
):
    """Provides the given color response to the interactive prompt. Multiple color
    responses can be provided within a single session, but only if the prompt
    has a color prompt.
    """
