...
async def up(itgs: Itgs) -> None:
    ...
    with temp_file(".bak") as backup_file:
        ...
        with open(backup_file, "rb") as f:
            await files.upload(
                ...
                key=f"s3_files/backup/database/timely/0192_screen_based_on_pro-{int(time.time())}.bak",
                sync=True,
            )

    cursor = conn.cursor("weak")

    additional_flags = 8 | 16
    ...
    while True:
        ...
        for row in response.results:
            ...
            new_row_screens = [
                {**screen, "flags": screen["flags"] | additional_flags}
    ...
    while True:
        ...
        for row in response.results:
            ...
            new_row_screen = {
                **row_screen,
                "flags": row_screen["flags"] | additional_flags,
            }
