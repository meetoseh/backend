...
SELECT
    ?, ?, ?, ?, ?, ?
        ...
        (
            ...
            "add_phone",
            "Add Phone",
            "Allows the user to enter a phone number or skip. If they enter a phone number, we send them a code which they need to enter (presumably on the next screen) in order to complete the add phone process. If they skip, we don't send them a code.",
