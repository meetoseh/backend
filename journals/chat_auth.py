"""Provides utility functions for working with journal chat jwts, which allow
the user to connect to /api/2/journals/chat to stream back a system message
"""
...
async def auth_presigned(itgs: Itgs, authorization: Optional[str]) -> AuthResult:
    ...
    token which provides access to a journal chat encrypted with a
