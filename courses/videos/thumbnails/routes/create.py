...
class CreateCourseVideoThumbnailRequest(BaseModel):
...
async def create_course_video_thumbnail(
    args: CreateCourseVideoThumbnailRequest,
    authorization: Annotated[Optional[str], Header()] = None,
):
    """Starts the process to create a new course video thumbnail. At least 1920x1080 is required,
    ...
    async with Itgs() as itgs:
        ...
        res = await start_upload(
            ...
            success_job_name="runners.process_course_video_thumbnail",
            success_job_kwargs={
