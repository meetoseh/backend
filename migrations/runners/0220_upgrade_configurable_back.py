    ...
    schema = {
        ...
        "properties": {
            ...
            "back": {
                ...
                "example": None,
                "deprecated": True,
                "description": "Prefer back2. Used only in version 73 and lower. The flow to trigger when the back button is pressed. Triggered with no parameters",
            },
            "back2": shared_screen_configurable_trigger_001(
