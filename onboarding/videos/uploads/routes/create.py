...
class CreateOnboardingVideoUploadRequest(BaseModel):
...
async def create_onboarding_video_upload(
    args: CreateOnboardingVideoUploadRequest,
    authorization: Annotated[Optional[str], Header()] = None,
):
    """Starts the process to create a new onboarding video upload. At least
    ...
    async with Itgs() as itgs:
        ...
        res = await start_upload(
            ...
            success_job_name="runners.process_onboarding_video_upload",
            success_job_kwargs={
