    ...
    schema = {
        ...
        "properties": {
            ...
            "upgrade_trigger": {
                "type": "string",
                "format": "flow_slug",
                "description": "The client flow to trigger when the user taps a journey that requires Oseh+, but they do not have Oseh+. Must include `journal_upgrade_for_journey`. Includes `journey_uid` in the server parameters",
                "example": "journal_upgrade_for_journey",
                "pattern": "^.*journal_upgrade_for_journey.*$",
            },
            "journey_trigger": {
                "type": "string",
                "format": "flow_slug",
            ...
            "suggestions": {
                ...
                "default": [
                    ...
                    {
                        "text": "I’m having trouble sleeping and need to calm my mind",
                        "width": 240,
                    },
                    {
                        "text": "I’m feeling a bit down and need encouragement",
                        "width": 238,
                    },
                    {
                        "text": "I’m feeling happy and want to cherish this moment",
                        "width": 220,
                    },
                ],
                "example": [
                ...
                "description": "The suggestions to use; an empty array removes suggestions. Only works on v96 or higher",
                "items": {
                    "type": "object",
                    "required": ["text", "width"],
                    "example": {
                        "text": "I have a lot of anxiety right now",
                        "width": 160,
                    },
                    "properties": {
                        "text": {
                            "type": "string",
                            "example": "I have a lot of anxiety right now",
                            "description": "The text of the suggestion",
                        },
                        "width": {
                            "type": "integer",
                            "example": 160,
                            "description": "The width of the suggestion in pixels at 1x font scaling",
                        },
                    },
                },
            },
