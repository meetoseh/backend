...
async def respond_to_interactive_prompt_press_prompt_end(
    args: CreateInteractivePromptEventRequest[EventRequestDataT],
    authorization: Optional[str] = Header(None),
):
    """Indicates the user stopped pressing down on a interactive prompt press prompt, but
    only if the prompt has a press prompt and the user is already pressing
